...
public class CartSampleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        float totalAmount = 0;
        ArrayList dbData = db.getCartData(username,"sample");
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(CartSampleActivity.this,TestSampleActivity.class));
            }
        });
        ...
        btnCheckout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent it = new Intent(CartSampleActivity.this,TestSampleBookActivity.class);
